...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_pdgfi6i', 'template_kpmnll8', form.current, 'IMI4rZ476FcEexHR1')
     e.target.reset();
  };
  return (
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>What's App</h4>
            <h5>9161741949</h5>
            <a href="http://api.whatsapp.com//send?phone=+919919039570" target='_blank'>Send a message</a>
          </article>
        </div>
